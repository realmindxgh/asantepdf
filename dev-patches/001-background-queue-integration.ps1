...
Replace-Exact $productShell `
    '    private readonly TaskCenterService _taskCenterService = new();`n    private RecentFilesView? _recentFilesView;' `
    '    private readonly TaskCenterService _taskCenterService = new();`n    private BackgroundTaskQueueService? _backgroundTasks;`n    private RecentFilesView? _recentFilesView;' `
    'background task service field'
